...
class EnhancedPickAndPlace(Node):
    def __init__(self):
        super().__init__('enhanced_pickandplace_node')
...
def main(args=None):
    ...
    pose_above_red = [
        world_coords_red[0], 
        world_coords_red[1], 
        world_coords_red[2] + 0.1,  # 10cm above
    ...
    pose_red = [
        world_coords_red[0], 
        world_coords_red[1], 
        world_coords_red[2] + 0.005,  # Slightly above to avoid collision
        1.0, 0.0, 0.0, 0.0
    ]
    ...
    pose_above_hole = [
        world_coords_hole[0], 
        world_coords_hole[1], 
        world_coords_hole[2] + 0.1,  # 10cm above
        1.0, 0.0, 0.0, 0.0
    ]
    ...
    pose_hole = [
        world_coords_hole[0], 
        world_coords_hole[1], 
        world_coords_hole[2] + 0.02,  # Position for placement, slightly above
        1.0, 0.0, 0.0, 0.0
    ]
